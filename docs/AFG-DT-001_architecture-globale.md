...
| 6 | `payment-service` | 5006 | Mobile Money, cartes, Wallet, Jetons (BiCoins), abonnements, revenus créateurs | MVP |
...
| `Wallet`, `Token(BiCoins)`, `Order`, `Subscription`, `Payout` | payment | `userId`, `gameId`, `creatorId` |
